...
public class AddonPackets {
    ...
    public static void init() {
        channel = NetworkRegistry.ChannelBuilder
                .named(new ResourceLocation(GerMain.MOD_ID, "channel"))
        ...
        channel.registerMessage(packetIndex++, PlayRespawnSoundPacket.class,
                PlayRespawnSoundPacket::encode, PlayRespawnSoundPacket::decode, PlayRespawnSoundPacket::handle,
